...
if __name__ == "__main__":
    ...
    trips_path      = os.path.normpath(os.path.join(base_dir, "../../../data/processed/res8/trips.csv"))
    facilities_path = os.path.normpath(os.path.join(base_dir, "../../../data/processed/facilities_cleaned.csv"))
    output_path     = os.path.normpath(os.path.join(base_dir, "../../../data/processed/final_trips.csv"))
    
    assign_facility_locations(trips_path, facilities_path, output_path)
