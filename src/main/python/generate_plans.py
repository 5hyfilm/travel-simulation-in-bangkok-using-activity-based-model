...
if __name__ == "__main__":
    ...
    input_path  = os.path.normpath(os.path.join(base_dir, "../../../data/processed/final_trips.csv"))
    output_path = os.path.normpath(os.path.join(base_dir, "../../../data/plan_100k.xml"))
    
    generate_matsim_plans(input_path, output_path, sample_size=100000)
